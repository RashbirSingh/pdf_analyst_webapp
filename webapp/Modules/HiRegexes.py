...
# regexGeneric["CASELAW"]= "(?m)([A-Z][A-Za-z]*\W{1,2s})(([A-Z]+[a-z]*\W{1,2})|(for\W{1,2})|(and\W{1,2})|(the\W{1,2})|(v\W{1,2}))*(\(No\.?\W{0,2}\d{1,2}\)\W{0,2}|\(in\Wliq\.?\)\W{1,2})?((\d+)?\W{0,2})([\[\(]\d{4}[\]\)]\W{0,2})((\d+)?\W{0,2})([A-Z]{2,5}\W{0,2})\d{1,5}"
## TODO: remove it with blackstone
